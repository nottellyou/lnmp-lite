...
echo "+-------------------------------------------------------------------+"
echo "|Reset MySQL/MariaDB root Password for LNMP-Lite, Written by hdwo.net|"
echo "+-------------------------------------------------------------------+"
echo "|    A tool to reset MySQL/MariaDB root password for LNMP-Lite      |"
echo "+-------------------------------------------------------------------+"
...
if [ $? -eq 0 ]; then
    echo "Password reset succesfully. Now killing mysqld"
    killall mysqld
    sleep 5
